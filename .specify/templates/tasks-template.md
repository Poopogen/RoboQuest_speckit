...
If tests are included, they MUST cover XR-to-robot integration and performance checks.
...
- [ ] T004 [P] Define performance budgets and metrics collection plan
...
- [ ] T010 Configure telemetry tracing across VR ↔ backend ↔ robot paths
...
- [ ] T012 [P] [US1] Integration test for XR↔robot path in tests/integration/test_[name].py
- [ ] T013 [P] [US1] Performance budget verification for VR↔backend↔robot in tests/perf/test_[name].py
...
- [ ] T020 [US1] Add UX parity validation checklist results to docs/
...
- [ ] T022 [P] [US2] Integration test for XR↔robot path in tests/integration/test_[name].py
- [ ] T023 [P] [US2] Performance budget verification for VR↔backend↔robot in tests/perf/test_[name].py
...
- [ ] T029 [P] [US3] Integration test for XR↔robot path in tests/integration/test_[name].py
- [ ] T030 [P] [US3] Performance budget verification for VR↔backend↔robot in tests/perf/test_[name].py
...
- [ ] TXXX [P] UX parity validation across all stories
